	...
	return (
		<Box>
			<Box display="flex" flexDirection="row" background="transparent">
				...
				>
					...
					{isLessThan1250 ? (
						...
						<Image
							...
							p="0 2rem"
							height={
								isHeightLargerThan1000 && isLargerThan1800
									? '110'
									: isLargerThan1800
									? '100'
									: isLargerThan1600
				...
				<Box
					mt={isHeightLargerThan1000 && isLargerThan1800 ? '5rem' : '4rem'}
					mr="1rem"
					ml={
						isLargerThan1800
							? '8rem'
					...
					<Image
						...
						height={
							isHeightLargerThan1000 && isLargerThan1800
								...
								: isLargerThan1800
								? '430'
								: isHeightLargerThan1000 && isLargerThan1600
								? '435'
								: isLargerThan1600
								? '430'
								: ''
