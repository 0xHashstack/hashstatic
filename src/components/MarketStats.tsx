...
import { Box, Skeleton, Spinner, Text, useMediaQuery } from '@chakra-ui/react'
            ...
            >
                ...
                <Box>
                        ...
                        {utilRate ?
                            ...
                            <Box color="#00D395" textAlign="center" fontFamily="inter" fontSize="36px" fontStyle="normal" fontWeight="600" lineHeight="40px" mt="0.4rem" whiteSpace="nowrap">
                                <Skeleton
                                    width="6rem"
                                    height="1.4rem"
                                    startColor="#101216"
            ...
            >
                ...
                <Box>
                        ...
                        {utilRate ?
                            <Text color="#00D395" textAlign="center" fontFamily="inter" fontSize="36px" fontStyle="normal" fontWeight="600" lineHeight="40px" mt="0.4rem" whiteSpace="nowrap">
                                {utilRate ? `${utilRate}%` : ""}
                            </Text> : <Box color="#00D395" textAlign="center" fontFamily="inter" fontSize="36px" fontStyle="normal" fontWeight="600" lineHeight="40px" mt="0.4rem" whiteSpace="nowrap">
                                <Skeleton
                                    width="6rem"
                                    height="1.4rem"
                                    startColor="#101216"
