...
const RunningBanner = () => {
	...
	return (
		<Box>
			...
			:	<Box
					display='flex'
					height={isLessThan1210 ? '50px' : ''}>
					<Box
						display='flex'
						bg='#000'
						padding={isLessThan1210 ? '0px 10px' : '0 10px'}>
						<Text
							color='#fff'
							width='100px'
							fontFamily='inter'
							fontSize='14px'
							fontWeight='600'
							lineHeight={isLessThan1210 ? '25px' : '40px'}>
							We work with
						</Text>
					</Box>
					<Box
						...
						background='rgba(217, 217, 217, 0.06)'
						overflow='hidden'
						paddingY={isLessThan1210 ? '0.9rem' : '1.2rem'}>
						{!isDrawerOpen && (
							<Marquee
								style={{
									display: 'flex',
                        ...
                        {iconDashboardHover == 1 ? <InfoIconWhite /> : <InfoIcon />}
							...
							<Link
								...
								<Box
									...
									onMouseEnter={() =>
										setIconDashboardHover(2)
									}
									onMouseLeave={() =>
										setIconDashboardHover(0)
									}>
									{iconDashboardHover == 2 ?
										<TwitterIconWhite />
									:	<TwitterIcon />}
								</Box>
							</Link>
							<Link
								...
								<Box
									...
									onMouseEnter={() =>
										setIconDashboardHover(3)
									}
									onMouseLeave={() =>
										setIconDashboardHover(0)
									}>
									{iconDashboardHover == 3 ?
										<DiscordLogoWhite />
									:	<DicordLogo />}
								</Box>
							</Link>
							<Link
								...
								<Box
									...
									onMouseEnter={() =>
										setIconDashboardHover(4)
									}
									onMouseLeave={() =>
										setIconDashboardHover(0)
									}>
									{iconDashboardHover == 4 ?
										<GithubIconWhite />
									:	<GithubIcon />}
								</Box>
							</Link>
							<Link
								...
								<Box
									...
									onMouseEnter={() =>
										setIconDashboardHover(5)
									}
									onMouseLeave={() =>
										setIconDashboardHover(0)
									}>
									{iconDashboardHover == 5 ?
										<FileIconWhite />
									:	<FileIcon />}
								</Box>
							</Link>
							<Link
								...
								<Box
									...
									onMouseEnter={() =>
										setIconDashboardHover(6)
									}
									onMouseLeave={() =>
										setIconDashboardHover(0)
									}>
									{iconDashboardHover == 6 ?
										<QueryIconWhite />
									:	<QueryIcon />}
								</Box>
							</Link>
