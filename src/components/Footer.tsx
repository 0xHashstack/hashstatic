...
const Footer = () => {
  ...
  return (
    <Box>
      {isHeightLargerThan850 && !isWidthLessThan1050 ?      <Box display="flex" flexDirection="row" justifyContent="space-between" position="fixed" bottom="0"  pt="1rem" pl="2rem" pr="2rem" pb="1rem" width="100%">
    ...
    </Box>:      <Box display="flex" flexDirection="row" justifyContent="space-between"  pt="1rem" pl="2rem" pr="2rem" pb="1rem" width="100%">
      <Box display="flex" flexDirection="row" gap="2.5rem">
        <Text color="#4D59E8" fontSize="14px" fontStyle="normal" fontWeight="500" lineHeight="20px" cursor="pointer">HomePage</Text>
        <Text color="#fff" fontSize="14px" fontStyle="normal" fontWeight="500" lineHeight="20px" cursor="pointer">Use Cases</Text>
        <Link href="https://docs.hashstack.finance/" target="_blank">
